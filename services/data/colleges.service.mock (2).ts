...
const mockColleges: College[] = [
  {
    ...
    goalsAr: 'إعداد أطباء متميزين وقادرين على المنافسة محلياً وإقليمياً، وتطوير البحث العلمي الطبي، وتقديم خدمات مجتمعية ذات جودة عالية.',
    goalsEn: 'Preparing distinguished physicians capable of competing locally and regionally, developing medical scientific research, and providing high-quality community services.',
    valuesAr: 'النزاهة، الأمانة المهنية، الاحترام، والتميز في الأداء الطبي.',
    valuesEn: 'Integrity, professional honesty, respect, and excellence in medical performance.',
    qualityAr: 'تلتزم الكلية بمعايير الجودة العالمية في التعليم الطبي والبحث العلمي لضمان مخرجات تعليمية متميزة.',
    qualityEn: 'The college is committed to international quality standards in medical education and scientific research to ensure outstanding educational outcomes.',
    strategyAr: 'تطوير البنية التحتية، تعزيز الشراكات الدولية، وتحديث المناهج الطبية باستمرار لتواكب التطورات العالمية.',
    strategyEn: 'Developing infrastructure, strengthening international partnerships, and continuously updating medical curricula to keep pace with global developments.',
    programs: [
      {
        id: 'med-1',
    ...
    news: [
      {
        ...
        descAr: 'افتتاح رسمي لمبنى الكلية الجديد بحضور كبار المسؤولين والطلاب.',
        descEn: 'Official opening of the new college building with senior officials and students.',
        date: '2025-01-15',
      ...
      },
      {
        ...
        descAr: 'الجامعة تحصل على جائزة التميز البحثي لعام 2025 تقديرًا لمساهماتها.',
        descEn: 'University receives Research Excellence Award for 2025 in recognition of its contributions.',
        date: '2025-01-10',
      ...
      },
      {
        ...
        descAr: 'توقيع اتفاقية شراكة استراتيجية مع جامعات رائدة في أوروبا للتبادل الطلابي.',
        descEn: 'Signing a strategic partnership agreement with leading European universities for student exchange.',
        date: '2025-01-05',
  ...
  },
  {
    ...
    goalsAr: 'توفير تعليم رائد في العلوم الصحية، وتطوير مهارات الطلاب المهنية، والمساهمة في تحسين النظام الصحي الوطني.',
    goalsEn: 'Providing leading education in health sciences, developing students professional skills, and contributing to improving the national health system.',
    valuesAr: 'العمل الجماعي، الإبداع، المسؤولية المجتمعية، والالتزام الأخلاقي.',
    valuesEn: 'Teamwork, creativity, social responsibility, and ethical commitment.',
    qualityAr: 'تطبيق أنظمة الجودة الشاملة في المختبرات والبرامج الأكاديمية لضمان كفاءة الخريجين.',
    qualityEn: 'Implementing comprehensive quality systems in laboratories and academic programs to ensure graduates competence.',
    strategyAr: 'التوسع في التخصصات الطبية المساندة، وتوفير أحدث التقنيات التعليمية والتدريبية.',
    strategyEn: 'Expanding in allied health specialties and providing the latest educational and training technologies.',
    programs: [
      {
        id: 'hs-1',
    ...
    news: [
      {
        ...
        descAr: 'افتتاح مكتبة رقمية تحتوي على أكثر من 50,000 مرجع علمي في مختلف التخصصات.',
        descEn: 'Opening of digital library containing over 50,000 scientific references across various disciplines.',
        date: '2024-12-20',
        image: 'https://images.unsplash.com/photo-1606811841689-23dfddce3e95?w=400&q=80',
        collegeId: 'health-sciences'
      },
      {
        id: 'hs-news-2',
        ...
        descAr: 'انطلاق النسخة الخامسة من مسابقة الابتكار الطلابي بمشاركة مشاريع مبتكرة.',
        descEn: 'Launch of the fifth edition of the Student Innovation Competition with innovative projects.',
        date: '2024-12-15',
      ...
      },
      {
        ...
        descAr: 'انطلاق البطولة الرياضية السنوية بمشاركة فرق من جميع الكليات في مختلف الألعاب.',
        descEn: 'Launch of the annual sports tournament with teams from all colleges in various sports.',
        date: '2024-12-10',
  ...
  },
  {
    ...
    goalsAr: 'إعداد مهندسين ومبرمجين متميزين، وتعزيز الابتكار التقني، وتقديم حلول هندسية لمشاكل المجتمع.',
    goalsEn: 'Preparing distinguished engineers and programmers, promoting technical innovation, and providing engineering solutions to community problems.',
    valuesAr: 'الابتكار، الدقة، الاستدامة، والريادة التكنولوجية.',
    valuesEn: 'Innovation, precision, sustainability, and technological leadership.',
    qualityAr: 'الالتزام بمعايير الاعتماد الهندسي (ABET) وتطبيق أفضل الممارسات في التعليم التقني.',
    qualityEn: 'Commitment to engineering accreditation standards (ABET) and applying best practices in technical education.',
    strategyAr: 'بناء مختبرات ذكية، وتعزيز التعاون مع قطاع الصناعة والتكنولوجيا.',
    strategyEn: 'Building smart labs and strengthening cooperation with the industrial and technology sector.',
    programs: [
      {
        id: 'eng-1',
    ...
    news: [
      {
        ...
        titleAr: 'مسابقة الابتكار الطلابي السنوية',
        titleEn: 'Annual Student Innovation Competition',
        descAr: 'مشاركة واسعة لطلاب الهندسة في مسابقة الابتكار السنوية بمشاريع تقنية متميزة.',
        descEn: 'Wide participation of engineering students in the annual innovation competition with outstanding technical projects.',
        date: '2024-12-15',
        image: 'https://images.unsplash.com/photo-1581091226825-a6a2a5aee158?w=400&q=80',
        collegeId: 'engineering-it'
      },
      {
        id: 'eng-news-2',
        ...
        descAr: 'فرص توظيف مباشرة لطلاب الهندسة وتقنية المعلومات بمشاركة شركات رائدة.',
        descEn: 'Direct employment opportunities for engineering and IT students with participation from leading companies.',
        date: '2024-11-28',
      ...
      },
      {
        ...
        titleAr: 'افتتاح مبنى الكلية الجديد',
        titleEn: 'Opening of New College Building',
        descAr: 'تجهيزات حديثة ومختبرات متطورة في مبنى الكلية الجديد لدعم التميز الأكاديمي.',
        descEn: 'Modern equipment and advanced laboratories in the new college building to support academic excellence.',
        date: '2025-01-15',
        image: 'https://images.unsplash.com/photo-15598397734-2b71ea197ec2?w=400&q=80',
        collegeId: 'engineering-it'
      }
    ]
  },
  {
    ...
    goalsAr: 'تطوير الكفاءات الإدارية والقانونية، وتعزيز مهارات التفكير النقدي، وتوفير تعليم يواكب العصر الرقمي.',
    goalsEn: 'Developing administrative and legal competencies, promoting critical thinking skills, and providing education that keeps pace with the digital age.',
    valuesAr: 'الشفافية، النزاهة، العدالة، والتواصل الفعال.',
    valuesEn: 'Transparency, integrity, justice, and effective communication.',
    qualityAr: 'تحسين الأداء المؤسسي المستمر وتطبيق معايير الجودة في كافة البرامج الإدارية والانسانية.',
    qualityEn: 'Continuous improvement of institutional performance and applying quality standards in all administrative and humanitarian programs.',
    strategyAr: 'تطوير البرامج المشتركة مع جامعات دولية، وتعزيز مهارات ريادة الأعمال لدى الطلاب.',
    strategyEn: 'Developing joint programs with international universities and enhancing students entrepreneurship skills.',
    programs: [
      {
        id: 'bus-1',
    ...
    news: [
      {
        ...
        titleAr: 'جائزة التميز البحثي للجامعة',
        titleEn: 'University Research Excellence Award',
        descAr: 'تكريم الباحثين في الكلية لمساهماتهم المتميزة في مجال البحث الإداري والمالي.',
        descEn: 'Honoring researchers in the college for their outstanding contributions in administrative and financial research.',
        date: '2025-01-10',
        image: 'https://images.unsplash.com/photo-1507679799987-c73779587ccf?w=400&q=80',
        collegeId: 'business-humanities'
      },
      {
        id: 'bus-news-2',
        slug: 'international-partnership',
        titleAr: 'شراكة دولية جديدة مع جامعات أوروبية',
        titleEn: 'New International Partnership with European Universities',
        descAr: 'فتح آفاق جديدة للتبادل الأكاديمي والطلابي في تخصصات إدارة الأعمال واللغات.',
        descEn: 'Opening new horizons for academic and student exchange in business administration and languages.',
        date: '2025-01-05',
      ...
      },
      {
        ...
        titleAr: 'إطلاق المكتبة الرقمية الشاملة',
        titleEn: 'Launch of Comprehensive Digital Library',
        descAr: 'كلية العلوم الإدارية تستلم صلاحيات الوصول للمكتبة الرقمية العالمية لخدمة الباحثين.',
        descEn: 'College of Administrative Sciences receives access rights to the international digital library to serve researchers.',
        date: '2024-12-20',
