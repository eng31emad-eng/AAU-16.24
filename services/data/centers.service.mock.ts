...
const mockCenters: CenterItem[] = [
  ...
  },
  {
    ...
    descAr: 'مركز متخصص في ضمان جودة التعليم وتطوير المعايير الأكاديمية والمؤسسية',
    descEn: 'Specialized center for ensuring educational quality and developing academic and institutional standards',
    services: [
      { ar: 'اعتماد البرامج الأكاديمية', en: 'Academic program accreditation' },
      { ar: 'تقييم الأداء المؤسسي', en: 'Institutional performance evaluation' },
      { ar: 'التدريب على معايير الجودة', en: 'Quality standards training' },
      { ar: 'إعداد تقارير الجودة السنوية', en: 'Annual quality report preparation' },
      { ar: 'متابعة مؤشرات الأداء الرئيسية', en: 'Monitoring key performance indicators' },
    ],
    programs: [
      { ar: 'برنامج ضمان الجودة الأكاديمية', en: 'Academic Quality Assurance Program' },
      { ar: 'برنامج الاعتماد المؤسسي', en: 'Institutional Accreditation Program' },
      { ar: 'برنامج التحسين المستمر', en: 'Continuous Improvement Program' },
      { ar: 'برنامج تقييم الكفاءة', en: 'Competency Evaluation Program' },
    ],
  },
];
