...
import { researchService, ResearchArticle } from '@/services/data/research.service.mock';
...
export default function ArticlesClient() {
    ...
    const categories = [
        ...
        { id: 'Medical', ar: 'العلوم الطبية', en: 'Medical' },
        { id: 'Engineering', ar: 'الهندسة', en: 'Engineering' },
        { id: 'Administrative', ar: 'العلوم الإدارية', en: 'Administrative' },
    ];
    ...
    useEffect(() => {
        const fetchArticles = async () => {
            try {
                const data = await researchService.getAllArticles();
                setArticles(data || []);
    ...
    useEffect(() => {
        ...
        if (activeCategory !== 'all') {
            result = result.filter(a => a.categoryEn.includes(activeCategory));
        }
        if (searchQuery) {
