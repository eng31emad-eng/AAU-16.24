...
export function UniversityVideoSection() {
    const { t } = useLanguage()
        ...
        <section className="py-20 bg-background relative overflow-hidden">
            ...
            <div className="container mx-auto px-4 relative z-10">
                <div className="text-center mb-12">
                    ...
                    >
                        {t('لقطات من جامعتنا', 'Glimpses of Our University')}
                    </motion.h2>
                    ...
                    >
                        {t('شاهد بيئة التعليم الحديثة والمرافق المتطورة التي نقدمها لطلابنا', 'Experience our modern learning environment and advanced facilities.')}
                    </motion.p>
                </div>
                    ...
                    <div className="aspect-video rounded-3xl overflow-hidden border-4 border-secondary/20 shadow-2xl relative">
                        ...
                        <div className="absolute bottom-6 left-6 right-6 md:bottom-10 md:left-10 p-4 md:p-6 backdrop-blur-md bg-white/10 border border-white/20 rounded-2xl md:max-w-md hidden sm:block">
                            <h3 className="text-white font-bold text-xl mb-2">
                                {t('جولة في الحرم الجامعي', 'Campus Virtual Tour')}
                            </h3>
                            <p className="text-white/80 text-sm">
                                {t('استكشف القاعات الدراسية والمعامل المجهزة بأحدث التقنيات.', 'Explore classrooms and laboratories equipped with the latest technologies.')}
                            </p>
                        </div>
                    </div>
